...
/**
 * 
 *  Class Name: GlobalConstant.java
 *  
 *  @author Yu Liu  DateTime 2013-10-26 下午4:44:06    
 *  @version 1.0
...
public class GlobalConstant {
    ...
    public static String SELECTED_ADDRESS_TYPE ;
    
    public interface URLContact {}
    
    public interface DBContact {
    	public static final String DB_NAME = "com.jouhu.wangju.db";
    ...
    public interface MessageConstant {
    	...
    	public static final String ADD_OK = "联系人信息添加成功";
    	public static final String EDIT_OK = "联系人信息编辑成功";
    }
