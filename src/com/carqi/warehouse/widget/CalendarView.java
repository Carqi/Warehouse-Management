...
public class CalendarView extends View implements View.OnTouchListener {  
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        surface.width = (int) viewWidth;  
        surface.height = (int) (getResources().getDisplayMetrics().heightPixels*2/4);  
...
//    }  
    ...
    private class Surface {  
        ...
        public int width; // 整个日历控件的宽度
        public int height; // 整个日历控件的高度 
        public float monthHeight; // 显示月的高度  
        public float monthChangeWidth; // 上一月�?下一月按钮宽�? 
        public float weekHeight; // 显示星期的高度 
        public float cellWidth; // 日期方框宽度  
        public float cellHeight; // 日期方框高度    
        public float borderWidth;  
        public int bgColor = Color.parseColor("#FFFFFF");  //控件背景 
        ...
        public int cellDownColor = Color.parseColor("#FF9103");  
        ...
        public void init() {  
            ...
            monthHeight = (float) ((temp + temp * 0.6f) * 0.6);  
            monthChangeWidth = monthHeight * 1.5f;  
            weekHeight = (float) ((temp + temp * 0.5f) * 0.7);  
            ...
            boxPath.rLineTo(0, height - monthHeight);
            boxPath.moveTo(7 * cellWidth-1, 0);  
            boxPath.rLineTo(0, width);
